...
export const chordIntervals: {[key: number]: {full: string, short: string, symbol: string}} = {
  25:  {full: "Suspended second",                           short: "unknown", symbol: "sus2"    },
  52:  {full: "Suspended fourth",                           short: "unknown", symbol: "sus4"    },
  55:  {full: "Quartal",                                    short: "unknown", symbol: "q4"      },
  77:  {full: "Quintal",                                    short: "unknown", symbol: "q5"      },
  33:  {full: "Diminished",                                 short: "dim",     symbol: "\uE870"  },
